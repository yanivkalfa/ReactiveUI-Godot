    ...
    <Box sx={Styles.section}>
      ...
      <List sx={Styles.list}>
        <ListItem disablePadding>
          <ListItemText primary={<><code>V</code> — factory for building the virtual node tree. Function components: <code>V.fc(render_fn, props, children, key)</code> and <code>V.memo(...)</code>. Host elements are named 1:1 after their Godot classes: <code>V.Button</code>, <code>V.Label</code>, <code>V.VBoxContainer</code>, <code>V.HBoxContainer</code>, <code>V.LineEdit</code>, <code>V.PanelContainer</code>, … plus the generic <code>V.h(&quot;GodotClassName&quot;, props, children, key)</code> that reaches any Node class. Structural factories stay lowercase: <code>V.fragment</code>, <code>V.portal</code>, <code>V.suspense</code>, <code>V.error_boundary</code>. (GDScript reserves <code>func</code>, so the component factory is <code>V.fc</code>, not <code>V.func</code>.)</>} />
        </ListItem>
        <ListItem disablePadding>
