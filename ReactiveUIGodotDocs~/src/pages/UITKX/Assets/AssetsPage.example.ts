...
export const EXAMPLE_BASIC = `Avatar(image_path) -> RUIVNode {
...
export const EXAMPLE_RELATIVE = `Card() -> RUIVNode {
...
export const EXAMPLE_SHORTHAND = `Badge() -> RUIVNode {
...
export const EXAMPLE_INLINE = `Logo() -> RUIVNode {
...
export const EXAMPLE_FONT = `Heading(title) -> RUIVNode {
...
export const EXAMPLE_STYLEBOX = `Framed() -> RUIVNode {
...
export const EXAMPLE_AUDIO = `Chime() -> RUIVNode {
